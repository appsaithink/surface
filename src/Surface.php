...
abstract class Surface
{
    ...
    protected function init()
    {
        ...
        $this->addScript(
            [
                '<script src="/assets/crud/js/vue.js"></script>',
                '<script src="/assets/crud/js/axios.min.js"></script>',
                '<script src="/assets/crud/js/index.min.js"></script>',
                '<script src="/assets/crud/js/'. $this->name.'.js"></script>',
            ]
        );
    }

    protected $theme = [
            '<link href="/assets/crud/css/index.css" rel="stylesheet">',
        ];
